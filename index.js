    ...
    function writeToFile(filename, data, errorMessage) {
      try {
    ...
    // Write the HTML content to a file with error handling
    writeToFile('buy_orders.html', htmlContent, 'Error generating HTML file.');

    // Write the data to JSON file with error handling
    writeToFile('buy_orders.json', JSON.stringify(randomBuyOrders, null, 2), 'Error generating JSON file.');
